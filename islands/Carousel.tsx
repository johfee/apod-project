...
const SLIDE_DATA = [
  {
    color: "bg-[#479f9d]",
    text: "The Astronomic Picture of the Day project is built using TypeScript, Deno, and the Fresh Framework.",
    url: asset("/gallery/slide1.png"),
  },
  {
    color: "bg-[#413f57]",
    text: "It leverages data from NASA's Open API, which is ported to Deno and hosted on Deno Deploy.",
    url: asset("/gallery/slide2.png"),
  },
  {
    color: "bg-[#413f57]",
    text: "With this project, users can explore stunning astronomical images captured by NASA and learn about the wonders of the cosmos.",
    url: asset("/gallery/slide3.png"),
  },
  {
    color: "bg-[#479f9d]",
    text: "Enjoy exploring the universe through the APOD project.",
    url: asset("/gallery/slide4.png"),
  },
];
...
const Slide = (props: SlideProps) => {
  ...
  return (
    <div
      key={key}
      class={`${props.class} ${color} h-80 w-full text-center text-black p-5 flex items-center justify-center mt-4 rounded-xl`}
    style={`background-image: url(${url})`}>
      <div class="text-xl lg:text-4xl mx-16 bg-[rgba(255,255,255,0.9)] p-2 rounded-lg">{text}</div>
    </div>
  );
};
